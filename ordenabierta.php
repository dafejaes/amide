 ...
 * se cargan datos
 */
$ORDENES = new ControllerOpenOrder();
$ORDENES->ordenabiget();
        ...
        <div>
            <table class="table table-hover dyntable" id="dynamictable">
                ...
                <tr>
                    ...
                    <th class="head0">Ubicacion equipo</th>
                    <th class="head1">Extension</th>
                    <th class="head0">Responsable</th>
                    <th class="head1">Fecha apertura</th>
                    <th class="head0">Patrones</th>
                ...
                if ($isvalid) {
                    for ($i = 0; $i < $c; $i++) {
                        ...
                        <tr class="gradeC">
                            ...
                            <td class="con0"><?php echo 'Torre: ' . $arrclientes[$i]['torre'] . '. Piso: ' . $arrclientes[$i]['piso'] . '. Ubicacion: ' . $arrclientes[$i]['ubicacion']; ?></td>
                            <td class="con1"><?php echo $arrclientes[$i]['extension']; ?></td>
