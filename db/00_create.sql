...
CREATE TABLE IF NOT EXISTS `amide_db`.`am_usuarios` (
  ...
  `usr_identificacion` VARCHAR(70) NULL,
...
CREATE TABLE IF NOT EXISTS `amide_db`.`am_equipos_tipo` (
  ...
  `eqt_id2` VARCHAR(60) NOT NULL,
  `eqt_actualizado` DATETIME NULL,
  `eqt_borrado` TINYINT NULL,
  `eqt_clase` VARCHAR(60) NULL,
  `eqt_tipo` VARCHAR(60) NULL,
  PRIMARY KEY (`eqt_id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `amide_db`.`am_partec` (
  `partec_id` INT NOT NULL AUTO_INCREMENT,
  `am_equipos_tipo_eqt_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `amide_db`.`am_vmetro` (
  `vmetro_id` INT NOT NULL AUTO_INCREMENT,
  `am_equipos_tipo_eqt_id` INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `amide_db`.`am_recepcion` (
  `recp_id` INT NOT NULL AUTO_INCREMENT,
  ...
  `rcp_certificado` VARCHAR(100) NULL,
  `rcp_fechaentrega` DATETIME NULL,
  `rcp_entregado` TINYINT NULL,
  PRIMARY KEY (`recp_id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `amide_db`.`am_orden` (
  ...
  `or_director_id` INT NULL,
  `or_tiempo_empleado` TIME NULL,
  `or_borrado` INT NULL,
  `or_responsable` INT NULL,
  PRIMARY KEY (`or_id`))
ENGINE = InnoDB;
